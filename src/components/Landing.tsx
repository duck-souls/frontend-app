    ...
    <div>
      <div className="bg-gradient-to-b p-10 from-[#FFF068] to-[#FEE715] flex flex-col-reverse lg:flex-row items-center">
        <div className="ml-10 max-w-fit text-[#101820]">
          ...
          <button className="bg-[#807426] hover:bg-[#101820] hover:text-[#fff] rounded-md py-1 px-2.5 mt-5 font-bold w-32">
            Click me
          </button>
        </div>
        <img
      ...
      <div className="bg-gradient-to-b from-[#0A0C0F] to-[#101820] flex items-center">
        ...
        <div className="mr-10 text-[#fff] max-w-fit">
          ...
          <button className="bg-[#CD7F32] hover:bg-[#fff] hover:text-[#101820] rounded-md py-1 px-2.5 mt-5 font-bold w-32">
            Click me
          </button>
        </div>
      </div>
