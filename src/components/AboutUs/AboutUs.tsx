    ...
    >
      ...
      <div className="flex flex-1 justify-center">
        ...
        <button
          ...
          className="border border-black-700 py-1.5 px-2.5 bg-[#F4E9D9] rounded-lg  ml-2 hover:bg-[#AA895E] hover:text-white mb-4 mt-5 cursor-pointer"
        >
          Contact Us
        </button>
      </div>
      <Modal
        ...
        className="bg-white mr-[-50%] translate-x-[-50%] translate-y-[-50%] left-1/2 top-1/2 right-auto bottom-auto h-1/4 w-[400px] m-4 border border-black-700 p-5 rounded-lg shadow-[0_35px_60px_-10px_rgba(0,0,0,0.4)] ml-11 desktop:w-fit grid grid-cols-1 w-"
      >
        <div>
        ...
        <button onClick={() => setModalOpen(false)}>Hola</button>
      </Modal>
    </div>
  );
};
